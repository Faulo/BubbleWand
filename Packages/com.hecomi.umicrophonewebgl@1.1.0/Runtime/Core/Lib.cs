...
namespace uMicrophoneWebGL {
    ...
    public static extern bool IsRecording();
#else
        static GameObject _recordGameObj = null;
        static EditorMicrophoneDataRetriever _micInputRetriever = null;
        ...
        public static void Start() {
            ...
            string deviceId = GetDeviceId(_deviceIndex);
            int freq = GetSampleRate(_deviceIndex);
